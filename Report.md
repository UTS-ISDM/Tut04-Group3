# Executive Summary
<p align="justify"> Through the introduction of the newly developed Call Management System, the report aims to analyse, propose and to exhibit its capabilities as an information system built solely to improve user efficiciency and provide clarity. From various evaluations on the existing system, it was deemed that the system at present had multitudes of flaws and spawned unneeded complexities in the process which led to a great loss of revenue for the company. However, with stakeholder analysis the report documents how each of the stakeholders internal or external to the system will interact and bring forth a change based on their words and how will the newly developed features seek to aid these stakeholders for the product at hand. Moreover, the use of SCRUM has greatly benefitted this project as it allowed for a priotised backlog to be produced which led to an even split of workload which eventually led to sprints on a bi-weekly basis to smoothen the development process. Overall, the report will document the workings of the system with an analysis through a system evaluation aimed to hollow out any of advantages or disadvantages faced by the system in the future. </p>
...
<p align="justify"> Throughout the duration of the project, the members of the team as we have agreed to use SCRUM will document and develop the system over multiple iterations where possible, for this the group will meet once every week to have an online team retrospective meeting on what has been done over the previous week and to bring to light on what else must be done for the coming weeks. Also important to this will be continous commits with well worded messages so that each member will be able to keep track on what has been done for each commit cycle. Whenever an issue arises the member must bring up the issue either through GitHub's issue feature or through the team chat for others to help review and work on the issue and to resolve it as soon as possible. </p>
